...
import { classNames, Container, IconButton, MaxWidth, Select, SushiIcon, Typography } from '..'
    ...
    >
      ...
      >
        <div className="flex items-center flex-grow gap-3">
          <a className="flex flex-row items-center gap-1.5" href="https://stealth.org/">
            ...
            <Select.Options className="w-[max-content] !bg-slate-700 -ml-5 mt-5 !max-h-[unset]">
              <div className="grid grid-cols-1 gap-1 px-2 py-2 md:grid-cols-3">
                <div>
                  ...
                  <Select.Option
                    as="a"
                    href="https://stealth.org/applications"
                    key={AppType.Wallet}
                    value={AppType.Wallet}
                  ...
                  <Select.Option
                    as="a"
                    href={`${process.env.NEXT_PUBLIC_EARN_URL}/earn"`}
                    key={AppType.Invest}
