...
> = {
  Services: {
    ...
    Earn: { href: `${process.env.EARN_URL}/earn` },
    /* 'Lending & Borrowing': {
  ...
  Help: {
    ...
    'About Us': {
      href: 'https://stealth.org/what-is-stealth',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
    'Discord Support': {
      href: 'https://discord.com/invite/qGwMQQeRPm',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
    'Twitter Support': {
      href: 'https://twitter.com/stealthsend',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
    'Reddit Support': {
      href: 'https://www.reddit.com/r/StealthSend/',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
  },
  Developers: {
    ...
    GitHub: {
      href: 'https://github.com/Stealth-R-D-LLC',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
    /* Development: {
      ...
      <Container maxWidth="5xl" className="grid grid-cols-1 md:grid-cols-[176px_auto] mx-auto px-4 gap-4">
        <div className="flex flex-col gap-5">
          <div className="flex items-center justify-start gap-3 pt-2">
            <SushiWithTextIcon height={48} className="text-slate-50" />
          </div>
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/Stealth-R-D-LLC" target="_blank" rel="noopener noreferrer">
              <GithubIcon width={16} className="text-slate-300 hover:text-slate-50" />
            </a>
            <a href="https://twitter.com/stealthsend" target="_blank" rel="noopener noreferrer">
              <TwitterIcon width={16} className="text-slate-300 hover:text-slate-50" />
            </a>
            <a href="https://www.instagram.com/stealthsend_official" target="_blank" rel="noopener noreferrer">
              <InstagramIcon width={16} className="text-slate-300 hover:text-slate-50" />
            </a>
            <a href="https://discord.com/invite/qGwMQQeRPm" target="_blank" rel="noopener noreferrer">
      ...
      <Container maxWidth="5xl" className="mx-auto mt-20 mb-5">
        <div className="flex justify-between py-2 mx-4 border-t border-slate-800">
          <Typography variant="xs" className="text-slate-400">
            Copyright © 2023 Stealth. All rights reserved.
          </Typography>
          <div className="flex divide-x divide-slate-200/20 gap-">
            <Link.External href="https://stealth.org/terms-of-use">
              <Typography variant="xs" weight={500} className="px-3 text-slate-300">
                Terms of Use
              </Typography>
            </Link.External>
